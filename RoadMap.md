...
- [x] **Fix Regressions**: Addressed major regressions by re-implementing logical/comparison operators, generics, and lambda expressions in the new parser.
...
- [x] **Enums and Pattern Matching**: Implement algebraic data types (`enum`). (`match` statement still pending).
