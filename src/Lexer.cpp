...
const std::map<std::string, TokenType> Lexer::keywords = {
    ...
    {"print", TokenType::PRINT}, {"input", TokenType::INPUT}, {"fs_read", TokenType::FS_READ}, {"fs_write", TokenType::FS_WRITE},
    {"type_cast", TokenType::TYPE_CAST}, {"iostream", TokenType::IOSTREAM}, {"filesystem", TokenType::FILESYSTEM},
