...
private:
    ...
    std::unique_ptr<FunctionStmt> functionDeclaration(const std::string& kind, bool has_body = true, Access access = Access::PUBLIC, std::unique_ptr<TypeExpr> trait_impl = nullptr);
