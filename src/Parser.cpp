...
std::unique_ptr<Stmt> Parser::importStatement() {
    ...
    } else if (match(TokenType::IDENTIFIER, TokenType::IOSTREAM, TokenType::FILESYSTEM, TokenType::OPERATOR, TokenType::REFLECT, TokenType::META, TokenType::UTIL, TokenType::STRING_TYPE, TokenType::ARRAY, TokenType::OS, TokenType::TIME, TokenType::RANDOM)) {
        path = previous();
    } else {
...
std::unique_ptr<Expr> Parser::unary() {
    if (match(TokenType::BANG, TokenType::MINUS, TokenType::STAR, TokenType::PLUS_PLUS, TokenType::MINUS_MINUS, TokenType::TILDE)) {
        Token op = previous();
        auto right = unary();
...
std::unique_ptr<Expr> Parser::primary() {
    ...
    if (match(TokenType::IDENTIFIER, TokenType::PRINT, TokenType::INPUT, TokenType::META, TokenType::OPERATOR, TokenType::REFLECT, TokenType::UTIL, TokenType::STRING_TYPE, TokenType::ARRAY, TokenType::OS, TokenType::TIME, TokenType::RANDOM, TokenType::FILESYSTEM)) {
